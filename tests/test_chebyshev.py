...
import squiggle.polynomials as pu
from squiggle.polynomials import chebyshev as cs
...
class TestChebyshev(jtu.JaxTestCase):
    ...
    def testChebline(self, dtype_off, dtype_scl, mul):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_off, dtype_scl]):
            self._CheckAgainstNumpy(
                ncs.chebline, cs.chebline, args_maker, check_dtypes=False
            )
    ...
    def testChebadd(self, dtype1, dtype2, length1, length2, trailing1, trailing2):
        ...
        def args_maker():
            ...
            return (
                jnp.concatenate([c1, jnp.zeros(trailing1, c1.dtype)]),
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype1, dtype2]):
            self._CheckAgainstNumpy(
                ncs.chebadd, cs.chebadd, args_maker, check_dtypes=False
            )
            self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebsub(self, dtype1, dtype2, length1, length2, trailing1, trailing2):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype1, dtype2]):
            self._CheckAgainstNumpy(
                ncs.chebsub, cs.chebsub, args_maker, check_dtypes=False
            )
            self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebmulx(self, dtype, length, trailing):
        ...
        self._CheckAgainstNumpy(
            ncs.chebmulx, cs.chebmulx, args_maker, check_dtypes=False
        )
        self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebmul(self, dtype1, dtype2, length1, length2, trailing1, trailing2):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype1, dtype2]):
            self._CheckAgainstNumpy(
                ncs.chebmul, cs.chebmul, args_maker, check_dtypes=False, tol=tol
            )
            self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebdiv(self, dtype1, dtype2, length1, length2, trailing1, trailing2):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype1, dtype2]):
            self._CheckAgainstNumpy(
                ncs.chebdiv, cs.chebdiv, args_maker, check_dtypes=False, tol=tol
            )
            self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebval(self, dtype_x, dtype_c, length, trailing, pts, tensor):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_x, dtype_c]):
            self._CheckAgainstNumpy(
                np_fn, jnp_fn, args_maker, check_dtypes=False, tol=tol
            )
            self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebint(self, dtype, length, trailing, m, k, lbnd):
        ...
        def np_fn(c, k_vals):
            return ncs.chebint(c, m=m, k=k_vals, lbnd=lbnd)

        def jnp_fn(c, k_vals):
            return cs.chebint(c, m=m, k=k_vals, lbnd=lbnd)

        def jnp_fn_jit(c, k_vals):
            return cs.chebint(c, m=m, k=k_vals, lbnd=lbnd, trim=False)
    ...
    def testCheb2poly(self, dtype, length, trailing):
        ...
        self._CheckAgainstNumpy(
            ncs.cheb2poly, cs.cheb2poly, args_maker, check_dtypes=False
        )
        self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testPoly2cheb(self, dtype, length, trailing):
        ...
        self._CheckAgainstNumpy(
            ncs.poly2cheb, cs.poly2cheb, args_maker, check_dtypes=False
        )
        self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebfromroots(self, dtype, length):
        ...
        self._CheckAgainstNumpy(
            ncs.chebfromroots, cs.chebfromroots, args_maker, check_dtypes=False
        )
    ...
    def testChebfit(self, dtype_x, dtype_y, length, degree, rcond, full, usew):
        ...
        def jnp_fn(x, y, w):
            return cs.chebfit(x, y, degree, rcond=rcond, full=full, w=w)

        def jnp_fn_jit(x, y, w):
            return cs.chebfit(
                x, y, degree, rcond=rcond, full=full, w=w, numpy_resid=False
            )

        def np_fn(x, y, w):
            return ncs.chebfit(x, y, degree, rcond=rcond, full=full, w=w)
    ...
    def testChebroots(self, dtype, length):
        ...
        self._CheckAgainstNumpy(
            ncs.chebroots, cs.chebroots, args_maker, check_dtypes=False, tol=tol
        )
        self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebpts1(self, npts):
        ...
        self._CheckAgainstNumpy(
            ncs.chebpts1, cs.chebpts1, args_maker, check_dtypes=False, tol=tol
        )
    ...
    def testChebpts2(self, npts):
        ...
        self._CheckAgainstNumpy(
            ncs.chebpts2, cs.chebpts2, args_maker, check_dtypes=False, tol=tol
        )
    ...
    def testChebval2d(self, dtype_x, dtype_c, val_length, c_length, trailing):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_x, dtype_c]):
            self._CheckAgainstNumpy(
                ncs.chebval2d, cs.chebval2d, args_maker, check_dtypes=False, tol=tol
            )
    ...
    def testChebval3d(self, dtype_x, dtype_c, val_length, c_length, trailing):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_x, dtype_c]):
            self._CheckAgainstNumpy(
                ncs.chebval3d, cs.chebval3d, args_maker, check_dtypes=False, tol=tol
            )
    ...
    def testChebgrid2d(self, dtype_x, dtype_c, val_length, c_length, trailing):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_x, dtype_c]):
            self._CheckAgainstNumpy(
                ncs.chebgrid2d, cs.chebgrid2d, args_maker, check_dtypes=False, tol=tol
            )
    ...
    def testChebgrid3d(self, dtype_x, dtype_c, val_length, c_length, trailing):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_x, dtype_c]):
            self._CheckAgainstNumpy(
                ncs.chebgrid3d, cs.chebgrid3d, args_maker, check_dtypes=False, tol=tol
            )
    ...
    def testChebvander3d(
        self, dtype_x, dtype_y, dtype_z, length, x_degree, y_degree, z_degree
    ):
        rng = jtu.rand_default(self.rng())
        ...
        jnp_fn = partial(
            cs.chebvander3d, deg_x=x_degree, deg_y=y_degree, deg_z=z_degree
        )
        ...
        tol = max(
            jtu.tolerance(dtype, tolerance) for dtype in [dtype_x, dtype_y, dtype_z]
        )
        tol = reduce(jtu.join_tolerance, [tolerance, tol, jtu.default_tolerance()])
    ...
    def testChebcompanion(self, dtype, length):
        ...
        self._CheckAgainstNumpy(
            ncs.chebcompanion, cs.chebcompanion, args_maker, check_dtypes=False
        )
        self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testChebgauss(self, degree):
        ...
        self._CheckAgainstNumpy(
            ncs.chebgauss, cs.chebgauss, args_maker, check_dtypes=False, tol=tol
        )
    ...
    def testChebweight(self, dtype, length):
        ...
        self._CheckAgainstNumpy(
            ncs.chebweight, cs.chebweight, args_maker, check_dtypes=False
        )
    ...
    def testChebinterpolate(self, func_id, degree):
        ...
        def jnp_fn(func, deg):
            return cs.chebinterpolate(func[0], deg)

        def np_fn(func, deg):
            return ncs.chebinterpolate(func[1], deg)
...
class TestPolyutils(jtu.JaxTestCase):
    ...
    def testAsSeries(self, dtype, length, count):
        ...
        self._CheckAgainstNumpy(
            npu.as_series, pu.as_series, args_maker, check_dtypes=False
        )
        self._CompileAndCheck(jnp_fn, args_maker)
    ...
    def testTrimcoef(self, dtype, length, tol):
        ...
        self._CheckAgainstNumpy(
            npu.trimcoef, pu.trimcoef, args_maker, check_dtypes=False
        )
    ...
    def testGetdomain(self, dtype, length):
        ...
        self._CheckAgainstNumpy(
            npu.getdomain, pu.getdomain, args_maker, check_dtypes=False
        )
    ...
    def testMapdomain(self, dtype_x, dtype_d, length):
        ...
        with jtu.strict_promotion_if_dtypes_match([dtype_x, dtype_d]):
            self._CheckAgainstNumpy(
                np_fn, pu.mapdomain, args_maker, check_dtypes=False, tol=tol
            )
